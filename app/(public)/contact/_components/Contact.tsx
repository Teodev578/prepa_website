            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <div className="overflow-hidden py-2 sm:py-3">
                        ...
                        >
                            <span className="block pb-1 sm:pb-2">DEMANDE</span>
                            <span className="block">DE DEVIS <span className="text-foreground inline-block transform translate-y-1 md:translate-y-2 opacity-30"></span></span>
                        </motion.h1>
                    </div>
