  ...
  return (
    <div className="max-w-4xl mx-auto px-6 md:px-12 w-full">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter text-foreground font-sans">
        ...
        <motion.div
          ...
          className="max-w-none space-y-12 pb-12"
        >
          {/* Article 1 */}
          <section className="mb-10">
            <h2 className="flex items-center gap-3 text-card-title text-foreground mb-6">
