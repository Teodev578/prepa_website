      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className={`bg-surface p-8 md:p-10 border-t-2 border-transparent hover:border-primary transition-all duration-300 ${
                t.highlight ? "lg:scale-105 z-20 shadow-2xl" : ""
              }`}
            >
              ...
              <p className="text-on-background font-body italic mb-8 leading-relaxed">
                {t.text}
              </p>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-surface-container-highest flex items-center justify-center font-headline font-bold text-primary">
                  {t.initials}
                </div>
                <div>
                  <div className="text-white font-headline font-bold uppercase text-sm tracking-widest">
                    {t.name}
                  </div>
                  <div className="text-secondary text-[10px] font-label uppercase">
                    {t.car}
                  </div>
                </div>
              </div>
