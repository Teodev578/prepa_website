...
* **Sarah (`quality_assurance_engineer`)** : **Review Gatekeeper indépendante**, garante du passage réussi de `npm run check`, de l'audit de performance DevTools et de la conformité React 19 (`react-doctor`).
...
## 3. Système de Mémoire Partagée (`.agents/memory/`)
...
## 4. Protocole de Clôture Obligatoire (*Close-out Protocol*)
...
2. **Homologation Gatekeeper (Sarah) :**
   Vérification de l'absence de régressions React 19 et inspection du diff Git.
...
## 5. Next.js Strict Versioning Guardrails
